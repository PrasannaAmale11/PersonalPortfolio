...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className="home__title">Prasanna Amale
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
                ...
                <h3 className="home__subtitle"> Fullstack Developer
                </h3>
                <p className="home__description">I'm creative devloper based in Maharashtra, and I am very passionate and dedicated to my work</p>
