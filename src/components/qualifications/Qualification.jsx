        ...
        <div className="qualification__container container">
          <div className="qualification__tabs">
            <div
              className={
                toggleState === 1
                  ? "qualification__button button--flex qualification__active highlited"
            ...
            >
              <div className="qualification__data">
                <div>
                  ...
                  <span className="qualificaton__subtitle">
                    MIT, Aurangabad
                  </span>
